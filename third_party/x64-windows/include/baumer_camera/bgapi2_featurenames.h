...
#define SFNC_DEVICE_TEMPERATURESELECTOR "DeviceTemperatureSelector"
/**     \ingroup    Feature
...
/**     \ingroup    Feature
        \brief      Returns the unique integer Identifier value of the Source that the image comes from. */
#define SFNC_CHUNKSOURCEIDVALUE "ChunkSourceIDValue"
/**     \ingroup    Feature
        \brief      Returns the unique integer Identifier value of the Source that the image comes from. */
#define SFNC_CHUNKREGIONIDVALUE "ChunkRegionIDValue"
/**     \ingroup    Feature
        \brief      Returns a unique Identifier value that corresponds to the Group of Components of
                    the selected chunk Component. */
#define SFNC_CHUNKGROUPIDVALUE "ChunkGroupIDValue"
/**     \ingroup    Feature
...
/**     \ingroup    Feature
        \brief       */
#define SFNC_DEVICE_TEMPERATURESELECTORVALUE_SENSOR "Sensor"
/**     \ingroup    Feature
        \brief       */
#define SFNC_DEVICE_TEMPERATURESELECTORVALUE_MAINBOARD "Mainboard"
